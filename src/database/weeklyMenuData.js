...
export function getWeeklyMenus() {
  return [
    {
      weekStartId: '2026-04-20', // date of first day (monday) in a week
    ...
    {
      weekStartId: '2026-04-06', // date of first day (monday) in a week
      ...
      days: [
        {
          ...
          meals: [
            ...
            {
              id: '74e4eb3d-0a67-484d-beb3-dd76dfdba9f9', // uuid
              templateId: null, // null (when not templated meal)
              name: {cz: 'Svíčková', en: 'Beef Sirloin in Cream Sauce'},
              price: 145,
              allergens: [1, 7, 9],
