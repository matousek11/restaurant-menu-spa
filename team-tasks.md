...
- **IR03 – Asynchronní operace a side-effects**
	...
	- *Nezahrnuje:* samotné rozhodování o tom, zda jsou přihlašovací údaje správné (to dělá backend).
- **IR06 – Renderovací logika (View composition)**
	...
	- oddělení rozhodování *co* se má zobrazit (to řeší dispatcher) od toho *jak* se to zobrazí na obrazovce
## Vojtěch Kocourek
### Entita Allergen
- **stavy:**
...
- **IR07 – Handlery a vazba UI → akce**
	...
	- *Nezahrnuje:* přímé změny stavu aplikace v UI.
- **IR08 – Autentizace a technická autorizace**
	...
	- *Nezahrnuje:* business autorizaci (např. rozhodování, zda může uživatel upravovat jídla nebo pouze objednávat).
